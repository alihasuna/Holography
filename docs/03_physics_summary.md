...
respectively. A height inferred from a fixed measured phase with the wrong `V0` is therefore biased by
about +0.05 A per volt of underestimate at (4,-4,4). `V0` is a first-order systematic, not a
