...
| `tools/phase1_numbers.py` | The physics numbers added in revision 3 and Phase 2 (mean-inner-potential sensitivity at 12.53 V, sign and size of the height bias, shadow lengths); 19 self-checks. |
...
venv/bin/python tools/phase1_numbers.py                     # prints 19/19 checks pass
