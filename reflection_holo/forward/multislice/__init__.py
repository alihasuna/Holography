...
Typical use (every argument required; no default stands in for a PROJECT_INPUT):
    ...
    cell = forward.cell.build_reflection_cell(structure, vacuum_above_A=..., depth_below_A=...,
                                              ...
                                              entrance_vacuum_z_A=...)
    pot = AtomicPotential(cell, parameterisation="lobato",
...
from .engine import (GPU_ASSUMED, PLANE_TEXT, VALIDATION_STATUS, MultisliceParams,
                     estimate_resources, reflection_setup, run_realisation, simulate)
...
__all__ = [
    ...
    "reflection_setup", "run_realisation", "simulate",
    ...
    "PhysicalAbsorption", "absorber_profile_V", "propagate", "propagator_kernel",
    "propagator_phase",
]
